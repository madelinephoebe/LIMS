  ...
  <div class="row flex-nowrap">
    ...
    <div class="col">
      ...
      <div class="item_table" id="itemTableDisplay">
        <input type="text" id="searchInput" onkeyup="filterItems()" placeholder="Search for items..."><br><br>
    
<center><table class="table text-center table-hover" style="width: 1100px;">
  <thead>
    <tr>
      <th>
  ...
  <tbody>
        ...
        while ($row = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)) {
          ...
          if (isset($_POST['editItemNumber']) && $_POST['editItemNumber'] == $row['Item_Number']) {
            echo "<button class='saveButton' onclick='saveRow(" . $row['Item_Number'] . ")'>Save</button>";
          } else {
            echo "<button class='editButton' onclick='editRow(" . $row['Item_Number'] . ")'>Edit</button>";
            echo "<button class='deleteButton' button onclick='deleteRow(" . $row['Item_Number'] . ")'>Delete</button>";
          }
    ...
    <div id="addRowForm" style="display: none;"><br>
        <label for="newCategory">Category:</label><br>
        <input type="text" id="newCategory" name="newCategory" required><br>
        <br>
        <label for="newItemName">Item Name:</label><br>
        <input type="text" id="newItemName" name="newItemName" required><br>
        <br>
...
function displayReportsData(reportsData) {
  ...
  function toggleTable() {
    ...
    addButton.style.display = addButton.style.display === "none" ? "inline-block" : "none";
  };
